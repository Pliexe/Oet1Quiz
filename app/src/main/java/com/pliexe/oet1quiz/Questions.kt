...
val correctQuestions = arrayOf(
    ...
    CorrectQuestionWithImage("A pontszerű töltés körüli elektromos erőtér:", R.drawable.eq2),
    CorrectQuestionWithImage("A ponszerű töltés körüli pontok potenciálja:", R.drawable.eq3),
    CorrectQuestionWithImage("Arányossági együttható:", R.drawable.eq4),
    ...
    CorrectQuestionWithImage("Az elektromos áram erőssége:", R.drawable.eq11),
    CorrectQuestionWithImage("Az áram sűrűsége:", R.drawable.eq12),
    CorrectQuestionWithImage("Elektromos ellenállás:", R.drawable.eq13),
    CorrectQuestionWithImage("Elektromos vezetőképesség:", R.drawable.eq14),
    CorrectQuestionWithImage("Az elektromos ellenállás és a hőmérséklet összefüggése:", R.drawable.eq15),
    CorrectQuestionWithImage("A fajlagos ellenállás és a hőmérséklet összefüggése:", R.drawable.eq16),
    CorrectQuestionWithImage("Ohm törvénye:", R.drawable.eq17),
    CorrectQuestionWithImage("Joule törvénye:", R.drawable.eq18),
    CorrectQuestionWithImage("Az elektromos erők munkája:", R.drawable.eq19),
    CorrectQuestionWithImage("Eredő elnállás soros kapcsolás esetében:", R.drawable.eq20),
    CorrectQuestionWithImage("Eredő ellenállás párhuzamos kapcsolás esetében:", R.drawable.eq21),
)
